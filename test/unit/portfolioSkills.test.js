...
test('portfolio profile states full-stack work, native stack, and stack adaptation', () => {
  ...
  assert.match(PORTFOLIO_LOCALE_MESSAGES.en['portfolio.profile.summary'], /Lead AI & full-stack R&D engineer/);
  ...
  assert.match(PORTFOLIO_LOCALE_MESSAGES.en['portfolio.skill.agenticAi.summary'], /context engineering/);
  assert.match(PORTFOLIO_LOCALE_MESSAGES.en['portfolio.skill.agenticAi.summary'], /project graphs/);
  assert.match(PORTFOLIO_LOCALE_MESSAGES.en['portfolio.skill.agenticAi.summary'], /verifiable agent execution/);
  assert.match(PORTFOLIO_LOCALE_MESSAGES.en['portfolio.skills.details'], /RAG-style retrieval/);
  assert.match(PORTFOLIO_LOCALE_MESSAGES.en['portfolio.skills.details'], /structured execution state/);
  assert.match(PORTFOLIO_LOCALE_MESSAGES.en['portfolio.skill.agenticAi.summary'], /model\/resource routing/);
  assert.match(PORTFOLIO_LOCALE_MESSAGES.en['portfolio.skills.details'], /eval-style checks/);
  assert.match(PORTFOLIO_LOCALE_MESSAGES.en['portfolio.skill.agenticAi.details'], /guardrails/);
  assert.match(PORTFOLIO_LOCALE_MESSAGES.en['portfolio.skills.details'], /provider metadata/);
  ...
  assert.match(PORTFOLIO_LOCALE_MESSAGES.en['portfolio.profile.details'], /verifiable agent execution/);
  ...
  assert.match(PORTFOLIO_LOCALE_MESSAGES.en['portfolio.profile.workFormatDetails'], /inside an existing team, with a clear reporting/);
  assert.match(PORTFOLIO_LOCALE_MESSAGES.en['portfolio.profile.achievement.rndProducts.details'], /Created original product and technology lines/);
  ...
  assert.match(PORTFOLIO_LOCALE_MESSAGES.en['portfolio.profile.achievement.museumScanning.details'], /State Hermitage and Kunstkamera/);
  ...
  assert.match(PORTFOLIO_LOCALE_MESSAGES.en['portfolio.profile.achievement.aiTooling.details'], /resource-aware multi-agent orchestration/);
  assert.match(PORTFOLIO_LOCALE_MESSAGES.en['portfolio.profile.achievement.aiTooling.details'], /10-50x context reduction/);
  ...
  assert.match(PORTFOLIO_LOCALE_MESSAGES.en['portfolio.profile.experienceSummary'], /15\+ years in R&D, product engineering, and full-stack development/);
  ...
  assert.match(PORTFOLIO_LOCALE_MESSAGES.en['portfolio.skills.details'], /Core skills/);
  ...
  assert.match(PORTFOLIO_LOCALE_MESSAGES.ru['portfolio.profile.summary'], /Ведущий AI\/full-stack R&D-инженер/);
  assert.match(PORTFOLIO_LOCALE_MESSAGES.ru['portfolio.profile.summary'], /автоматизаци[яи] процессов/);
  ...
  assert.match(PORTFOLIO_LOCALE_MESSAGES.ru['portfolio.skill.agenticAi.summary'], /context engineering/);
  assert.match(PORTFOLIO_LOCALE_MESSAGES.ru['portfolio.skill.agenticAi.summary'], /графы проекта/);
  assert.match(PORTFOLIO_LOCALE_MESSAGES.ru['portfolio.skill.agenticAi.summary'], /проверяемое агентное исполнение/);
  assert.match(PORTFOLIO_LOCALE_MESSAGES.ru['portfolio.skills.details'], /RAG-style retrieval/);
  assert.match(PORTFOLIO_LOCALE_MESSAGES.ru['portfolio.skill.agenticAi.summary'], /маршрутизация моделей\/ресурсов/);
  assert.match(PORTFOLIO_LOCALE_MESSAGES.ru['portfolio.skills.details'], /guardrails/);
  assert.match(PORTFOLIO_LOCALE_MESSAGES.ru['portfolio.skills.details'], /provider metadata/);
  ...
  assert.match(PORTFOLIO_LOCALE_MESSAGES.ru['portfolio.profile.details'], /графовым пониманием проекта/);
  assert.match(PORTFOLIO_LOCALE_MESSAGES.ru['portfolio.profile.details'], /маршрутизацией моделей\/ресурсов/);
  assert.match(PORTFOLIO_LOCALE_MESSAGES.ru['portfolio.profile.details'], /проверяемым и аудируемым агентным исполнением/);
  ...
  assert.match(PORTFOLIO_LOCALE_MESSAGES.ru['portfolio.profile.workFormatDetails'], /внутри существующей команды, с понятной структурой руководства/);
  ...
  assert.match(PORTFOLIO_LOCALE_MESSAGES.ru['portfolio.profile.achievement.museumScanning.details'], /Эрмитаже и Кунсткамере/);
  ...
  assert.match(PORTFOLIO_LOCALE_MESSAGES.ru['portfolio.profile.achievement.aiTooling.details'], /resource-aware мультиагентная оркестрация/);
  assert.match(PORTFOLIO_LOCALE_MESSAGES.ru['portfolio.profile.achievement.aiTooling.details'], /сокращение контекста в 10–50 раз/);
  ...
  assert.match(PORTFOLIO_LOCALE_MESSAGES.ru['portfolio.profile.experienceSummary'], /15\+ лет в R&D, продуктовой инженерии и full-stack разработке/);
  ...
  assert.match(PORTFOLIO_LOCALE_MESSAGES.ru['portfolio.skills.details'], /Ключевые навыки/);
  ...
  assert.match(PORTFOLIO_LOCALE_MESSAGES.ru['portfolio.pdf.projectsTitle'], /Избранные проекты — подтверждение опыта/);

  assert.doesNotMatch(PORTFOLIO_LOCALE_MESSAGES.es['portfolio.page.title'], /hardware/i);
  assert.match(PORTFOLIO_LOCALE_MESSAGES.es['portfolio.profile.summary'], /Ingeniero líder de IA e I\+D full-stack/);
  ...
  assert.match(PORTFOLIO_LOCALE_MESSAGES.es['portfolio.skill.agenticAi.summary'], /context engineering/);
  assert.match(PORTFOLIO_LOCALE_MESSAGES.es['portfolio.skill.agenticAi.summary'], /grafos de proyecto/);
  assert.match(PORTFOLIO_LOCALE_MESSAGES.es['portfolio.skill.agenticAi.summary'], /ejecución verificable de agentes/);
  assert.match(PORTFOLIO_LOCALE_MESSAGES.es['portfolio.skills.details'], /RAG-style retrieval/);
  assert.match(PORTFOLIO_LOCALE_MESSAGES.es['portfolio.skills.details'], /compresión de contexto/);
  assert.match(PORTFOLIO_LOCALE_MESSAGES.es['portfolio.skill.agenticAi.summary'], /enrutamiento de modelos\/recursos/);
  assert.match(PORTFOLIO_LOCALE_MESSAGES.es['portfolio.skills.details'], /guardrails/);
  assert.match(PORTFOLIO_LOCALE_MESSAGES.es['portfolio.skills.details'], /provider metadata/);
  ...
  assert.match(PORTFOLIO_LOCALE_MESSAGES.es['portfolio.profile.details'], /ejecución verificable y auditable de agentes/);
  ...
  assert.match(PORTFOLIO_LOCALE_MESSAGES.es['portfolio.profile.workFormatDetails'], /Trabajo remoto de I\+D/);
  ...
  assert.match(PORTFOLIO_LOCALE_MESSAGES.es['portfolio.profile.achievement.museumScanning.details'], /Hermitage y la Kunstkamera/);
  ...
  assert.match(PORTFOLIO_LOCALE_MESSAGES.es['portfolio.profile.achievement.aiTooling.details'], /orquestación multiagente resource-aware/);
  assert.match(PORTFOLIO_LOCALE_MESSAGES.es['portfolio.profile.achievement.aiTooling.details'], /reducción de contexto de 10-50x/);
  ...
  assert.match(PORTFOLIO_LOCALE_MESSAGES.es['portfolio.profile.experienceSummary'], /15\+ años en I\+D, ingeniería de producto y desarrollo full-stack/);
  ...
  assert.match(PORTFOLIO_LOCALE_MESSAGES.es['portfolio.skills.details'], /Habilidades clave/);
