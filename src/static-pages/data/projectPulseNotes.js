export const PROJECT_PULSE_NOTES = Object.freeze({
  en: {
    ...
    'mcp-agent-portal': {
      summary: 'Journal note on the open MCP control-plane experiment that supports the Agent Portal product line.',
  ...
  ru: {
    ...
    'mcp-agent-portal': {
      summary: 'R&D-заметка об открытом MCP-контуре управления, который поддерживает продуктовую линию Agent Portal.',
  ...
  es: {
    ...
    'mcp-agent-portal': {
      summary: 'Nota I+D sobre el experimento abierto de control plane MCP que sostiene la línea de producto Agent Portal.',
    ...
    'symbiote-ui': {
      summary: 'Nota I+D sobre Web Components y metadata de providers como contrato UI para productos ensamblados por agentes.',
